...
\begin{itemize}
    \item \textbf{Jelölés:} $r_f(l) \rightarrow$ hányadik az $l$ lány az $f$ fiú preferencialistáján
    \item \textbf{Jelölés:} $r_l(f) \rightarrow$ hányadik az $f$ fiú az $l$ lány preferencialistáján
\end{itemize}
