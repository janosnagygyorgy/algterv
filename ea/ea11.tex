...
$h[i,j]$ számolásakor feljegyezzük, hogy $t_i$ beválasztása vagy kihagyása volt kedvezőbb, a jobb alsó sarokból indulva ezek segítségével rekonstruálható egy optimális megoldás.
...
\textbf{1. Részproblémák}\\
$R[i,j]$ a $t_1, t_2, \cdots, t_i$ tárgyakból választhatunk és legalább $j$ összértéket akarunk elérni minimális összsúly mellett.
