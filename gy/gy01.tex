...
\subsection{Naiv algoritmus (nem feltétlen termináló)}
...
\textbf{Algoritmus}
\begin{enumerate}
    \item Keressünk instabilitást a párosításban: egy fiúnak jobban tetszik egy másik lány ÉS aa lánynak jobban tetszik egy másik fiú.
...
\subsection{Gale-Shapley algoritmus}
\sethlcolor{orange}
\hl{(zh. feladat)}
