...
\begin{tabular}{l l}
    l[1,1] = 0 & l[1,2] = 25 \times 30 \times 10 = 7500 \\
...
\textbf{"1. lépés: átlós kitöltés":} amikor egy adott $l[i,j]$-t számítjuk, már minden $l[i,k]$ és $l[k+1, j]$ ismert.
...
\textbf{2. lépés: "korábbi szorzások":} optimális zárójelezése $A_1 A_2 A_3$-nak és $A_4 A_5 A_6$-nak
\begin{flalign*}
    & A_1 A_2 A_3 \rightarrow k[1,3] = 1 \rightarrow A_1 (A_2 A_3) &&\\
    & A_4 A_5 A_6 \rightarrow k[4,6] = 5 \rightarrow (A_4 A_5) A_6 &&
\end{flalign*}
Szumma szummárum: $(A_1 (A_2 A_3))((A_4 A_5) A_6)$
