...
\begin{itemize}
    \item Ha megegyeznek (rekurzív képlet 2. esete): az átlós (egy sorral fentebb és egy oszloppal előbb lévő) elem + 1
    \item Ha különböznek (rekurzív képlet 3. esete): a sorban előtte lévő elem és az oszlopban felette lévő elem közül a maximális (megállapodás: ha egyenlőek akkor a fölötte lévő)
\end{itemize}
